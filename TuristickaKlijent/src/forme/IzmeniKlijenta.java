...
public class IzmeniKlijenta extends javax.swing.JDialog {
     ...
     */
    public IzmeniKlijenta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        popuniMesta();
    }
    ...
    public void setKlijent(Klijent klijent) {
        ...
        txtBrojTelefona.setText(klijent.getBrojTelefona());
        txtImeKlijenta.setText(klijent.getImeKlijenta());
        txtPrezimeKlijenta.setText(klijent.getPrezimeKlijenta());
        cmbMesto.setSelectedItem(klijent.getMesto());
    }

    public void setPk(PretragaKlijenta pk) {
        this.pk = pk;
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Izmeni klijenta");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Klijent k = new Klijent(this.klijent.getSifraKlijenta(), ime, prezime, brojTelefona, adresa, mesto);
        
        KlijentskiZahtev kz = new KlijentskiZahtev(Operacije.IZMENA_KLIJENTA, k);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IzmeniKlijenta dialog = new IzmeniKlijenta(new javax.swing.JFrame(), true);
