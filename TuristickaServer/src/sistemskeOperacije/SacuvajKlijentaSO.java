 ...
 * @author Lenovo
 */
public class SacuvajKlijentaSO extends OpstaSistemskaOperacija{
    ...
    public ServerskiOdgovor operacija(OpstiDomenskiObjekat odo) throws Exception {
        ...
        try {
            ...
            transferObjekat.setPoruka("Sistem je sacuvao klijenta");
        } catch (SQLException ex) {
            Logger.getLogger(SacuvajKlijentaSO.class.getName()).log(Level.SEVERE, null, ex);
            throw new Exception("Sistem nije sacuvao klijenta");
        }
