...
public class IzmeniKlijentaSO extends OpstaSistemskaOperacija{
    ...
    public ServerskiOdgovor operacija(OpstiDomenskiObjekat odo) throws Exception {
        ...
        try {
            ...
            transferObjekat.setPoruka("Sistem je azurirao klijenta");
        } catch (SQLException ex) {
            Logger.getLogger(IzmeniKlijentaSO.class.getName()).log(Level.SEVERE, null, ex);
            throw new Exception("Sistem nije azurirao klijenta");
        }
